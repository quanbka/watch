...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210820_watch_b2a684afadcbe2b81224_20210820013624_archive.zip';
	const ARCHIVE_SIZE		 = '494081';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b2a684a-20013624';
    const SECONDARY_PACKAGE_HASH = 'a792341-20013624';
	const VERSION			 = '1.4.2';
